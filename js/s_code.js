...
/***********************************************************************************************************/
function installOmniDownloadTrackers (regexp) {
	...
	function setTracker() {
		...
		s.linkTrackVars = 'prop8,eVar3,events';
...
function TrackLinks() {
	installOmniDownloadTrackers("download.*?mozilla.org|download.html");
}
...
function s_doPlugins(s) {
	...
	/* External Campaigns */
	if(!s.campaign){
		s.campaign=s.getQueryParam('utm_id');
    ...
    if(!s.prop11) {
        s.prop11 = BrowserDetect.browser + " " + BrowserDetect.version; 
    }
